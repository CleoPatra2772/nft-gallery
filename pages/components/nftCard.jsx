export const NFTCard = ({nft}) => {
    return (
        <div className='w-1/4 flex flex-col'>
            ...
            <div className='flex flex-col y-gap-2 px-2 py-3 bg-purple-100 rounded-b-md h-110'>
                <div className=''>
            ...
            <div className="flex justify-center mb-1">
                <a className='py-2 px-4 bg-purple-500 w-1/2 text-center rounded-m text-white cursor-pointer' target={"_blank"} href={`http://etherscan.io.token${nft.contract.address}`}>View on Etherscan</a>
            </div>
